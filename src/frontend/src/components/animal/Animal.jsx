export default function Animal({ selectedAnimal, onClick, animalMood }) {
    const images = {
    ...
    const src = images[selectedAnimal + (animalMood === "traurig" ? "Traurig" : "")] || null;
    ...
    return (
      ...
      >
        {src ? (
          <img src={src} alt={selectedAnimal} className="w-28 h-28 object-contain block" />
        ) : (

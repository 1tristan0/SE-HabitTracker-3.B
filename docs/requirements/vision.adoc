...
Dieses Visions-Dokument bezieht sich auf das System {project-system-name}, das von HabitTracker-3.B entwickelt wird. Das System wird es Jugendlichen und Erwachsenen erlauben, spielerische und soziale Komponenten zu nutzen, um die Motivation während der Umstellung der Gewohnheiten nicht zu verlieren.
...
„Gewohnheitstier“ begegnet diesem Problem mit einer spielerischen, emotional ansprechenden Komponente: einem digitalen Begleiter (Buddy) – einem Maskottchen, das die Nutzer:innen auf ihrer Gewohnheitsreise begleitet.

Der Einsatz eines solchen Avatars schafft emotionale Bindung, stärkt das Verantwortungsgefühl und macht den Prozess der Verhaltensänderung positiv. Die Kombination aus Fortschritten und Gamification erhöht somit die langfristige Nutzungsdauer und Zielerreichung.
...
| Mobile App für Android und iOS mit intuitivem Interface |

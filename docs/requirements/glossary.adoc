...
| Alltagsroutine | Alltagsroutine ist eine regelmäßig wiederkehrende Abfolge von Handlungen, die den Tagesablauf strukturieren und Orientierung sowie Stabilität im Alltag geben. | Routine 
...
| Bewusst Leben | Bewusst leben bedeutet beim Habit-Tracking, Gewohnheiten gezielt wahrzunehmen, zu steuern und kontinuierlich zu verbessern.|
...
| Gewohnheitsreise | Eine Gewohnheitsreise ist der persönliche Entwicklungsprozess, bei dem bestehende Verhaltensmuster reflektiert, gezielt verändert und neue, nachhaltige Gewohnheiten aufgebaut werden. |
| Gewohnheitstier | Icon eines Tieres, das Emotionen zeigt und zum Durchhalten motiviert | Avatar, Maskottchen 
...
| Mediengewohnheiten | Mediengewohnheiten sind individuelle, regelmäßig ablaufende Verhaltensmuster im Umgang mit analogen und digitalen Medien. |
| Offline-Aktivitäten | Offline-Aktivitäten sind regelmäßig ausgeführte Handlungen oder Beschäftigungen, die ohne die Nutzung digitaler Medien stattfinden. |
| Performance | Performance bezeichnet die messbare Leistung oder das sichtbare Verhalten einer Person in Bezug auf bestimmte Aufgaben, Ziele oder Anforderungen.|
| Positive Verstärkung | Positive Bestärkung ist eine Methode, bei der erwünschtes Verhalten durch angenehme Reize oder Belohnungen gefördert und somit langfristig gefestigt wird. |
| Psychischer Druck | Psychischer Druck ist ein innerer Spannungszustand, der durch hohe Erwartungen, Stress oder selbst auferlegte Verpflichtungen entsteht und das Denken, Fühlen und Handeln beeinflusst. |
| Selbstverbesserung | Selbstverbesserung ist der bewusste Prozess, eigene Fähigkeiten, Verhaltensweisen oder Lebensumstände kontinuierlich weiterzuentwickeln und zu optimieren.| Selbstoptimierung
...
| Tools | Tools sind unterstützende Mittel oder Anwendungen, die dabei helfen, Gewohnheiten zu planen, zu verfolgen und langfristig zu etablieren. |

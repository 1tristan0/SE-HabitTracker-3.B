...
| Dashboard | Übersicht mit Kennzahlen (Streak-Länge, Erfolgsquote, Heatmap) zur Fortschrittskontrolle. |  Übersicht
| Eintrag | Bestätigung, dass eine Gewohnheit an einem Tag ausgeführt wurde. | Check-in 
// | Erinnerung | zeit- oder ortsbasierte Benachrichtigung, die den Nutzer zum Check-in auffordert. | Push Notification
| Fortschrittsring | kreisförmige Darstellung in der Kalenderansicht zur Darstellung des Erfüllungsgrads einer Gewohnheit. Der Fortschritt wird als farbiger Anteil eines kreisförmigen Umrings dargestellt, wobei die Länge des farbigen Segments proportional zum erreichten Fortschritt ist (z. B. 50 % = halber Kreis). Der Fortschrittsring dient der schnellen, intuitiven Einschätzung des aktuellen Status. | Progress Ring
...
| Gewohnheit | regelmäßig wiederholte Handlung. | Habit

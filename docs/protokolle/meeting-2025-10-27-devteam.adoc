...
| 1
| Unklarheit B011
| "bereits erledigt visuell unterscheidbar" - wie umsetzen? (detailiertere Beschreibung). Eventuell Refinement nötig?
| Tristan
| offen
...
| Tristan
| erledigt (VL04 + Gespräch Prof.Anke)

| 5
| Definition of Ready 
| Arbeiten wir tatsächlich nach DOR, ist DOR eventuell anzupassen? Insbesondere die letzten 5 Punkte hier: xref:../project_management/project_plan.adoc#dor[ProjectPlan.adoc -> 4.1 Definiton of Ready]
| Tristan
| offen
...
| 2
| Überlegungen/Ausarbeitungen zu Änderungen der DB für kommende Features (B006 und B029)
| Martin
| in Arbeit
| 17.11.2025

...
=== Projekt-Team / Rollen
Im Rahmen des ersten Team-Meetings zu Beginn des neuen Semesters wurde die bestehende Rollenverteilung überprüft und leicht angepasst. Felix Prockl unterstützt fortan das Development-Team, während Monika Keil neben ihrer Funktion als Ansprechpartnerin die Rolle der Scrum Masterin übernimmt. Ziel dieser Änderung ist eine ausgewogenere Verteilung der Aufgaben sowie eine verbesserte Abstimmung innerhalb des Teams.
